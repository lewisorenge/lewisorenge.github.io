...
function typeOnTerminal() {
    ...
    var myStack = start + whiten('Skill Set?') + waitAndBreak + ['Angular/Typescript', 'Django/Python', 'ReST API', 'Kotlin', 'Java',  'MySQL', 'Postgres', 'Shell Scripting', 'HTML5/Bootstrap/CSS Ninja'].join(',^500 ');
    var experience = getYearsBetween(new Date("February 1 2017 00:00"));
